> **Legacy documentation:** This file preserves the repository's former root README for historical context. It describes an older combined MongoDB-era setup and does not represent the current Backoffice architecture. Use the [current README](../../README.md) for setup and verified project information.
>
